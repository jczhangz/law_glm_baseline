...
import requests
from tool.string_utils import full_to_half, half_to_full
...
headers = {
    ...
    'Authorization': f'Bearer {constants.zhipu_header_authorization}'
}
...
if __name__ == '__main__':
    # print(search_company_name_by_sub_info('关联上市公司股票简称', '劲拓股份'))
    # print(search_company_name_by_sub_info('关联上市公司全称', '深圳市劲拓自动化设备股份有限公司'))
    print(search_case_num_by_legal_document('被告', '九牧王股份有限公司'))
    # print(get_legal_document("(2020)闽0203民初9151号"))

    # print(search_company_name_by_info("公司简称", '劲拓股份'))

    # print(search_company_name_by_info('所属行业','批发业'))
    # [{'公司名称': '上海复蝶智能科技有限公司'}, {'公司名称': '深圳市劲彤投资有限公司'}]

    # if len(company_info_dict) != 0:
